...
var CELULAR_EMPRESA = '5511958431653';
...
cardapio.metodos = {
    ...
    // diminuir a quantidade do cardápio
    ...
    // aumentar a quantidade do cardápio
    ...
    adicionarAoCarrinho: (id) => {
        ...
        if (qntdAtual > 0) {
            ...
            if (item.length > 0) {
                ...
                // validar se já exite esse item no carrinho
    ...
    //validadação antes de prosseguir para etapa 3
    resumoPedido: () => {
    ...
    // ele atualiza o link do whatsApp
    finalizarPedido: () => {
